...
# - Zhang Z. et al. 2025. Nature 642, 47-52, for the numerical subrouting
#   of self-interacting dark matter (SIDM).
# - Jiang F. et al. 2023. MNRAS 521, 4630-4644, for the original algorithm
#   of SIDM isothermal model.
# - Chen Y. et al. 2023, ascl:2301.030 (https://ui.adsabs.harvard.edu/abs/2023ascl.soft01030C/abstract),
#   for the numerical package HIPP and PyHIPP.
#
# Run this script by:
# $ python sidm_given_baryon.py
#
# The function run_sidm() takes the properties of a cold-dark-matter (CDM) halo
# (assumed to be Navaro-Frenk-White profile here), and a given profile of baryon
# (represented numerically, so that it applies to an arbitrary profile),
# and returns the SIDM halo profile.
# A plot showing the circular velocity and density profiles of the SIDM, CDM,
# and baryon components will be saved as "out.pdf" upon successful execution.
